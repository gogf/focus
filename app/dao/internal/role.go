...
// RoleColumns defines and stores column names for table gf_role.
...
var (
	// Role is globally public accessible object for table gf_role operations.
	Role = &RoleDao{
		M:     g.DB("default").Table("gf_role").Safe(),
		Table: "gf_role",
		Columns: roleColumns{
			Id:        "id",          
            Name:      "name",        
