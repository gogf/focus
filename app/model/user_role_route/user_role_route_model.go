...
// arModel is a active record design model for table gf_user_role_route operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_user_role_route.
	Table = "gf_user_role_route"
	// Model is the model object of gf_user_role_route.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_user_role_route.
	Columns = struct {
		Id         string // 自增ID                                          
        RoleId     string // 角色ID                                          
        Name       string // 权限名称                                        
