...
// arModel is a active record design model for table gf_setting operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_setting.
	Table = "gf_setting"
	// Model is the model object of gf_setting.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_setting.
	Columns = struct {
		K          string // 键名      
        V          string // 键值      
