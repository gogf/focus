...
// arModel is a active record design model for table gf_user_stat operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_user_stat.
	Table = "gf_user_stat"
	// Model is the model object of gf_user_stat.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_user_stat.
	Columns = struct {
		UserId     string // 用户ID    
