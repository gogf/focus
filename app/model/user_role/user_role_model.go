...
// arModel is a active record design model for table gf_user_role operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_user_role.
	Table = "gf_user_role"
	// Model is the model object of gf_user_role.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_user_role.
	Columns = struct {
