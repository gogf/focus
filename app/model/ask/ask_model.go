...
// arModel is a active record design model for table gf_ask operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_ask.
	Table = "gf_ask"
	// Model is the model object of gf_ask.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_ask.
	Columns = struct {
		Id          string // 自增ID                                                  
