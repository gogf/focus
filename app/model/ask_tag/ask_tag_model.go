...
// arModel is a active record design model for table gf_ask_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_ask_tag.
	Table = "gf_ask_tag"
	// Model is the model object of gf_ask_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_ask_tag.
	Columns = struct {
		Id         string //           
        AskId      string // 话题ID    
        TagName    string // 标签名称  
