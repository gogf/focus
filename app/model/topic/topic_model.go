...
// arModel is a active record design model for table gf_topic operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_topic.
	Table = "gf_topic"
	// Model is the model object of gf_topic.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_topic.
	Columns = struct {
		Id          string // 自增ID                                                  
