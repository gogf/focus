...
// arModel is a active record design model for table gf_question_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_question_tag.
	Table = "gf_question_tag"
	// Model is the model object of gf_question_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_question_tag.
	Columns = struct {
		Id          string //           
