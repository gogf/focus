...
// arModel is a active record design model for table gf_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_tag.
	Table = "gf_tag"
	// Model is the model object of gf_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_tag.
	Columns = struct {
		Name       string // 标签名称      
        Count      string // 标签内容数量  
        CreatedAt  string //               
