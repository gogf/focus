...
// arModel is a active record design model for table gf_user_auth operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_user_auth.
	Table = "gf_user_auth"
	// Model is the model object of gf_user_auth.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_user_auth.
	Columns = struct {
		Id            string // UID                      
        UserId        string // 用户ID                   
