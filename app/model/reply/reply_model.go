...
// arModel is a active record design model for table gf_reply operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_reply.
	Table = "gf_reply"
	// Model is the model object of gf_reply.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_reply.
	Columns = struct {
		Id         string // 回复ID                                   
