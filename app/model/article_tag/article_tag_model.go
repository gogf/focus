...
// arModel is a active record design model for table gf_article_tag operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_article_tag.
	Table = "gf_article_tag"
	// Model is the model object of gf_article_tag.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_article_tag.
	Columns = struct {
		Id         string // 自增主键  
