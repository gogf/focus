...
// arModel is a active record design model for table gf_question operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_question.
	Table = "gf_question"
	// Model is the model object of gf_question.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_question.
	Columns = struct {
		Id          string // 自增ID                                                  
        Key         string // 唯一键名，用于程序硬编码，一般不常用                    
        CategoryId  string // 栏目ID                                                  
        UserId      string // 用户ID                                                  
        AdoptId     string // 采纳的回复ID                                            
        Title       string // 标题                                                    
        Content     string // 内容                                                    
