...
// arModel is a active record design model for table gf_user_login operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of gf_user_login.
	Table = "gf_user_login"
	// Model is the model object of gf_user_login.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table gf_user_login.
	Columns = struct {
		Id         string // 主键ID    
        UserId     string // 用户ID    
        Ip         string // 登录IP    
